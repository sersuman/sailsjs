module.exports = {
  ...
  exits: {
    success: {
      statusCode: 201,
      description: 'New Uer created',
    },
    emailAlreadyInUse: {
      statusCode: 400,
      description: 'Email address already exits',
    },
    error: {
  ...
  fn: async function (inputs, exits) {
    ...
    try{
      ...
      let newUser = await User.create({
        ...
        emailProofTokenExpiresAt:  sails.config.custom.emailProofTokenTTL,
      }).fetch();
      ...
      if (error.code === 'E_UNIQUE') {
        return exits.emailAlreadyInUse({
          message: 'Oops: an error accourred',
